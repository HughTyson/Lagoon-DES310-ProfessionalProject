...
namespace LookupTable
{
    ...
    /// </summary>
    public class LinearLookUpTable<T>
    {
        private T[] table;
        private int size;
        ...
        public LinearLookUpTable(int size_, float start_at_, float increment_)
        {
            table = new T[size_];
            size = size_;
            start_at = start_at_;
        ...
        public LinearLookUpTable(float start_at_, float end_at_, int size_)
        {
            table = new T[size_];
            size = size_;
            start_at = start_at_;
