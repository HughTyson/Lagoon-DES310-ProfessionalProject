...
namespace LookupTable
{
    ...
    /// </summary>
    public class Linear2DLookUpTable<T>
    {
        private T[] table;
        ...
        public Linear2DLookUpTable(int x_size_, int y_size_, float x_start_at_, float y_start_at_, float x_increment_, float y_increment_)
        {
        ...
        public Linear2DLookUpTable(float x_start_at_, float y_start_at_, float x_end_at_, float y_end_at_, int x_size_, int y_size_)
        {
            table = new T[y_size_ * x_size_];
